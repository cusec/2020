					...
					<div className="center-container center-container-margin">
						...
						<div className="event-container">
							...
							<div className="event-description">
								...
								<hr className="speaker-break" />
								<p >Maude is a Staff Software Engineer at Slack Technologies Inc., based out of San Francisco.  In her time at Slack, she’s worked on a few different teams: first as a product engineer building the Grid product, then as a performance engineer focused on scaling out the backend to handle some of our largest Enterprise customers <span role="img" aria-label="growth chart">📈</span>. She currently works on the infrastructure team, focusing on making sure that other backend engineers at Slack are as productive as they can possibly be <span role="img" aria-label="runner">🏃🏻‍♀️</span>.Prior to moving to the bay area, Maude was front-end software engineer at Rent the Runway in New York City <span role="img" aria-label="statue of liberty">🗽</span> working with the growth and customer acquisition team. Maude holds a BSc. in Software Engineering <span role="img" aria-label="student">👩🏻‍🎓</span> from McGill University in Montréal, QC <span role="img" aria-label="canada flag">🇨🇦</span>."</p>
								<hr />
							</div>
						</div>
						<div className="event-container">
